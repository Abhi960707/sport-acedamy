...
export default function ExportDropdown({ onExportPdf, onExportCsv, onPrint, showPrint, title = "Export" }) {
  ...
  return (
    <div className="relative w-full sm:w-auto" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 sm:right-0 left-0 sm:left-auto mt-2 w-full sm:w-48 bg-white border border-gray-100 rounded-2xl shadow-xl z-50 overflow-hidden animate-fade-in-up">
